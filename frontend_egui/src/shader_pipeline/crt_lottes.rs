...
pub const SHADER_SOURCE: &str = include_str!("../../shaders/crt-lottes-fast.glsl");

pub struct CrtLottesShader {
    program: glow::Program,
}

impl CrtLottesShader {
    pub fn new(gl: &glow::Context) -> Result<Self> {
        unsafe {
            ...
            if !gl.get_shader_compile_status(fragment_shader) {
                ...
                bail!("Fragment shader failed to compile: {}", log);
            }
...
impl ShaderPass for CrtLottesShader {
