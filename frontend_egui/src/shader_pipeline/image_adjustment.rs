...
pub const SHADER_SOURCE: &str = include_str!("../../shaders/image-adjustment.glsl");

pub struct ImageAdjustmentShader {
    program: glow::Program,
}

impl ImageAdjustmentShader {
...
impl ShaderPass for ImageAdjustmentShader {
